...
public class LoginActivity extends AppCompatActivity implements getLoginMess{
...
//        });
    ...
    void updateUI(String a) {
        ...
        if(loginJsonReturn.getState()) {
            ...
            editor.commit();//提交修改
            Log.i("111", userInfo.getString("userid","0"));
        }
        else {
...
//        Intent intent = new Intent(LoginActivity.this, checkNameActivity.class);
//        startActivity(intent);
//    }
//
//
